...
export class DashboardComponent implements OnInit {
  ...
  generateData(): void {
    ...
    for (let i=1; i< this._max_nodes; i++){this.cluster1.push(this.randomNode(i))};
    for (let i=1; i< this._max_nodes/2; i++){this.cluster2.push(this.randomNode(i))};
  }
